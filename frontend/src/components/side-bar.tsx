...
const SideBar = () => {
  ...
  const MenuUrl = [
    { label: "Dashboard", url: "/manager/dashboard", icon: <MdDashboard /> },
    { label: "Orders", url: "/manager/orders", icon: <MdOutlineShoppingCart /> },
    // { label: "Clients", url: "/admin/clients", icon: <MdPeople /> },
    {
      label: "Reservations",
      url: "/manager/reservations",
      icon: <MdEventSeat />,
    },
    { label: "Menu", url: "/manager/menus", icon: <MdRestaurantMenu /> },
    { label: "Categories", url: "/manager/categories", icon: <MdOutlineCategory /> },
    { label: "My company", url: "/manager/mycompany", icon: <FaBuilding /> },
    { label: "Tables", url: "/manager/tables", icon: <MdOutlineTableBar  /> },
